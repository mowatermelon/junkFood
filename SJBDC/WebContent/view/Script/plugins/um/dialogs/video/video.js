(function () {
    ...
    UM.registerWidget(widgetName, {
        ...
        createPreviewVideo: function (url) {
            ...
            if (url.indexOf("v.qq.com") < 0) {//表示是腾讯视频
                ...
                $("#eduiVideoPreview", me.$widget)[0].innerHTML = '<iframe scrolling="no" src="' + url + '" class="video_iframe" style="width:420px; height:280px; important; overflow: hidden;" data-src="' + url + '" allowfullscreen="" frameborder="0"></iframe>'
            }
