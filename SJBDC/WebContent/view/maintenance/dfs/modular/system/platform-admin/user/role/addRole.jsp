...
<html>
	<head>
		...
		<script type="text/javascript"
			src="modular/system/platform-admin/user/role/js/addRole.js"></script>
			...
			<div class="plan-left">
				...
				<div class="tab-pane active" id="basicInfoPanel">
					<s:form name="roleForm" class="form-horizontal"
						action="/user/role_save.action" method="post" id="roleForm">
						<!-- 添加隐藏域 -->
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<s:textfield name="role.roleName" class="form-control required" id="roleName" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<s:textarea name="role.roleRemark" id="roleRemark" class="form-control required" rows="3"  />
							</div>
						</div>
						<div class="form-group">
						</div>
							...
							<div class="col-md-12">
								<div>
									<a class="task-but3" href="javascript:;"
										onclick="addRole()"  style="margin-left:190px;">保存 </a>
					...
					<div class="container-fluid catalog-edit-guide-footer">
						<div class="row">
							<div class="col-md-12">
								<div>
								    <a class="task-but3" href="javascript:;"
										onclick="addUser()" style="margin-left: 200px;">保存 </a>
									<a class="task-but4" href="javascript:;"
										onclick="location='<%=basePath%>user/role_list.action'">返回 </a>
