CREATE TABLE sec_menu (
 MENU_ID  varchar2(128) NOT NULL,
  MENU_PARENT_ID  varchar2(128) DEFAULT NULL,
  MENU_NAME  varchar2(128) DEFAULT NULL,
  MENU_URL varchar2(512) DEFAULT NULL,
  MENU_REMARK  varchar2(128) DEFAULT NULL,
    MENU_DISPLAY  number(11) DEFAULT NULL,
    MENU_CODE  varchar2(128) DEFAULT NULL,
    MENU_SORT  decimal(8,0) DEFAULT NULL,
    MENU_USES_MARK  number(11) DEFAULT NULL,
    MENU_SYSTEM_TYPE  varchar2(128) DEFAULT NULL
   );
...
CREATE TABLE sec_operation (
  ...
  OPERATION_NAME  varchar2(128) DEFAULT NULL,
  OPERATION_CODE  varchar2(128) DEFAULT NULL,
  OPERATION_URL  varchar2(512) DEFAULT NULL,
  OPERATION_SORT decimal(8,0) DEFAULT NULL,
  OPERATION_USES_MARK number(11) DEFAULT NULL,
  OPERATION_PARENT_ID  varchar2(512) DEFAULT NULL,
  PRIMARY KEY (OPERATION_ID)
);

CREATE TABLE sec_organization (
  ORG_ID varchar2(128) NOT NULL,
  ORG_PARENT_ID  varchar2(128) DEFAULT NULL,
  ORG_CODE varchar2(128) DEFAULT NULL,
  ORG_NAME  varchar2(128) DEFAULT NULL,
  ORG_REMARK  varchar2(512) DEFAULT NULL,
  ORG_TELEPHONE  varchar2(20) DEFAULT NULL,
  ORG_FAX  varchar2(20) DEFAULT NULL,
 ORG_ZIP_CODE  varchar2(20) DEFAULT NULL,
  ORG_ADDRESS  varchar2(512) DEFAULT NULL,
  PRIMARY KEY (ORG_ID)
);
...
CREATE TABLE sec_role (
  ...
  ROLE_USES_MARK number(11) DEFAULT NULL,
  ROLE_REMARK varchar2(512) DEFAULT NULL,
  PRIMARY KEY (ROLE_ID)
);
...
CREATE TABLE sec_user (
  USER_IS_SUPER_ADMIN NUMBER(11) DEFAULT NULL,
  USER_CREATETIME timestamp  DEFAULT SYSDATE NOT NULL,
  USER_ENABLED_TIME timestamp DEFAULT to_date('2015-01-01 08:00:00','yyyy-mm-dd hh24:mi:ss') NOT NULL,
  USER_INVALID_TIME timestamp DEFAULT to_date('2015-01-01 08:00:00','yyyy-mm-dd hh24:mi:ss') NOT NULL ,
  USER_ID VARCHAR2(128) NOT NULL,
  USER_LOGIN_NAME VARCHAR2(128) DEFAULT NULL,
  USER_PASSWORD VARCHAR2(128) DEFAULT NULL,
  USER_USES_MARK NUMBER(11) DEFAULT NULL
);

INSERT INTO sec_user VALUES ('1', to_date('2015-07-28 16:58:15','yyyy-mm-dd hh24:mi:ss'), to_date('2015-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss'), to_date('2015-07-28 16:57:07','yyyy-mm-dd hh24:mi:ss'), '1eb69aed-2b82-45b0-a7f5-bc1629abb3a4', 'admin_dwms', 'e10adc3949ba59abbe56e057f20f883e', '1');
INSERT INTO sec_user VALUES ('0', to_date('2015-07-16 12:31:14','yyyy-mm-dd hh24:mi:ss'), to_date('2015-07-16 00:00:00','yyyy-mm-dd hh24:mi:ss'), to_date('2016-05-19 00:00:00','yyyy-mm-dd hh24:mi:ss'), '38b257cb-66e1-49f4-9c93-78d2d20ca403', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1');
INSERT INTO sec_user VALUES ('0', to_date('2015-07-29 14:08:02','yyyy-mm-dd hh24:mi:ss'), to_date('2015-07-29 00:00:00','yyyy-mm-dd hh24:mi:ss'), to_date('2017-01-31 00:00:00','yyyy-mm-dd hh24:mi:ss'), '87bb0042-13f1-4a94-ab57-d8be84cb3274', 'admin_dfms', 'e10adc3949ba59abbe56e057f20f883e', '1');

  
CREATE TABLE sec_pageelement (
  ELEMENT_ID varchar2(128) NOT NULL,
  ELEMENT_NAME varchar2(128) DEFAULT NULL,
  ELEMENT_CODE varchar2(128) DEFAULT NULL,
 ELEMENT_SORT decimal(8,0) DEFAULT NULL,
  ELEMENT_USES_MARK number(11) DEFAULT NULL,
  PRIMARY KEY (ELEMENT_ID)
); 

CREATE TABLE sec_permissions (
  PERM_ID   varchar2(128) NOT NULL,
  PERM_TYPE  varchar2(128) DEFAULT NULL,
  SYSTEM_TYPE  varchar2(128) DEFAULT NULL,
  PERM_NAME varchar2(128) DEFAULT NULL,
  PRIMARY KEY (PERM_ID)
); 
...
INSERT INTO sec_permissions VALUES ('ff2d682e-9e5c-415c-9e4d-e50e640d7def', 'menu', 'DFSCenter', '角色管理');
  ...
  PERM_ID  varchar2(128) DEFAULT NULL,
  MENU_ID varchar2(128) DEFAULT NULL
);
...
INSERT INTO sec_ref_menu_permissions VALUES ('020d1e0f-58f1-47d0-81e8-a9e6b0b2be0a', '5f8ab6fd-6852-48b2-a2ca-76e771580e85');
  ...
  PERM_ID varchar2(128) DEFAULT NULL,
  OPERATION_ID varchar2(128) DEFAULT NULL
);

CREATE TABLE sec_ref_org_role (
  ORG_ID varchar2(128) DEFAULT NULL,
  ROLE_ID varchar2(128) DEFAULT NULL
);

CREATE TABLE sec_ref_pageelement_perm (
  ELEMENT_ID varchar2(128) DEFAULT NULL,
  PERM_ID varchar2(128) DEFAULT NULL
);
...
INSERT INTO sec_ref_user_role VALUES ('1eb69aed-2b82-45b0-a7f5-bc1629abb3a4', '9489428b-d533-4075-8448-aa03f0477c6c');
  ...
  USER_ID varchar2(128) NOT NULL,
  USER_CH_NAME varchar2(128) DEFAULT NULL,
  USER_EN_NAME varchar2(128) DEFAULT NULL,
  USER_FULL_NAME  varchar2(128) DEFAULT NULL,
  USER_GENDER  varchar2(10) DEFAULT NULL,
  USER_AGE varchar2(10) DEFAULT NULL,
  USER_FILE_ID varchar2(128) DEFAULT NULL,
  USER_BIRTHDAY  varchar2(128) DEFAULT NULL,
  USER_PLACE  varchar2(128) DEFAULT NULL,
  USER_TELEPHONE  varchar2(128) DEFAULT NULL,
  USER_MOBILE  varchar2(128) DEFAULT NULL,
  USER_EMAIL  varchar2(128) DEFAULT NULL,
  USER_ADDRESS  varchar2(512) DEFAULT NULL,
  PRIMARY KEY (USER_ID)
);
