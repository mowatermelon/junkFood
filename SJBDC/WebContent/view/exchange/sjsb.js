...
var pageObj = {
        ...
        $(".btn-area a").off('click').on("click", function () {
            ...
            if (id) {
                ...
                if (id.indexOf("line") != -1) {
                    ...
                    that.initEchartLine("resultList2-bar-echart2", data, 5, 10, 'bar');
                }
        ...
        $('#' + target).bootstrapTable({
            ...
            onLoadSuccess: function (data) {
                if (target == 'resultList1') {
                    ...
                    that.initEchartLine("resultList1-bar-echart", data, 5, 10, 'bar');
                } else {
                    that.initEchartLine("resultList2-bar-echart1", data, 1, 4, 'bar');
                }
    ...
    getQueryParams: function () {
        ...
        return {
            queryId: target == 'resultList1' ? "SjjhQueryMapper.querySJSB" : "JgXnSjjhQueryMapper.querySJSB",
            queryMap: {
                startDate: that.queryParams.startDate,
                endDate: that.queryParams.endDate,
