...
<body>
	<div class="container-header">
		...
		<div class="plugin-box">
			<a class="city-box"> <input id="cityChoice" readonly value="广东省" />
	...
	<div class="container base-container tab-content">
		...
		<div class="tab-pane fade" id="city-area-box">
			...
			<div class="table-box fix-table">
				<div class="box-title">
					<span>汇交数据详情(按区域)</span>
					<div class="btn-area nav nav-tabs">
						<a class="selected" href="#echart-box-line">汇交详情</a><a
	...
	<script src="sjhj.js?v=${v }" type="text/javascript"></script>
