...
<head>
    ...
    <!-- 引用，关联组织机构的外部JS -->
    <script type="text/javascript" src="view/usersys/platform-admin/user/role/js/updateOrg.js"></script>    
    <%-- <script type="text/javascript" src="platform-admin/user/role/js/addRole.js"></script> --%>
    <script type="text/javascript" src="view/usersys/platform-admin/user/role/js/updateRole.js"></script>
        ...
        <div class="mainPanel">
            ...
            <div class="mainPanelContainer">
                ...
                <<!-- div class="currentPosition">
                    ...
                    <a href="#">用户管理</a> &gt 修改角色
                </div>
 -->
                <!-- 主面板内容 -->
                <div class="mainPanelContent">
                    <h3 class="functionTitle">修改角色</h3>
