		...
		$("#btnPerm").click(function(){
		   ...
		   $("#btnUser").click(function(){
			   ...
			   //alert("roleID:"+roleID);
				...
				$.post("user/user_queryUserAssociationRole.action?respType=JSON",{"roleID":roleID1,"choice":"0","user.userLoginName":userLoginName},function(result){
				...
				$.post("user/user_queryUserAssociationRole.action?respType=JSON",{"roleID":roleID1,"choice":"1","user.userLoginName":userLoginName},function(result){
						//alert(result);
						var userList = result.userList;
						for(var index = 0;index<userList.length;index++)
						{  
