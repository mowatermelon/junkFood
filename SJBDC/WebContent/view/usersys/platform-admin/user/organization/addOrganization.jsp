...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>GeoSmarter数据服务中心-组织结构管理</title>
		<meta charset="utf-8">
		<meta name="viewport"
		...
		<script type="text/javascript"
			src="view/usersys/platform-admin/user/organization/js/addOrganization.js"></script>
	...
	<body>
		<%-- <div class="position">
			<span>您的当前位置：<a href="javascript:void(0)">首页</a> -> <a
				href="javascript:void(0)">系统管理</a> -> 添加组织机构</span>
		</div> --%>
		<div class="system-edit">
			...
			<hr />
			<s:form id="addOrgformID" name="orgForm" class="form-horizontal"
				action="user/org_save.action" method="post">
