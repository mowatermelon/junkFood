...
<link type="text/css" rel="stylesheet" href="zsjgPage2.css">

<script type="application/javascript" src="zsjgPage2.js"></script>
		...
		<div class="mainContent">
			<div class="width100 height100" style="position: relative">
				...
				<div class="zongChart" id="zongChart">
					<div class="tipMsg">
						<span>计划印制总量为<b class="word12" id="JHYZZS"></b>,已印制总量为<b
							class="word13" id="YJFZL"></b>,已使用总量为<b class="word14" id="YSYSL"></b></span>
					</div>
					<div class="colaverage" id="zszmzzt" style="height: 40%"></div>
					<div class="colaverage fix-table" id="qszstable"
						style="height: 60%; font-size: 14px;padding-top:20px;">
