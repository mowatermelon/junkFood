...
<html>
<head>
    <title>武大吉奥GeoSmarter数据融合管理中心  - 用户</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">

    <link rel="stylesheet" href="/modular/system/fe-lib/bootstrap/3.3.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="/modular/system/fe-lib/bootstrap/3.3.2/css/bootstrap-theme.min.css">
    <link rel="stylesheet" href="/modular/system/fe-lib/jqueryui/1.10.4/themes/bootstrap3/jquery-ui-1.10.3.custom.css">
    <!--[if lt IE 9]>
    <link rel="stylesheet" href="../fe-lib/jqueryui/1.10.4/themes/bootstrap3/jquery.ui.1.10.3.ie.css">
    <![endif]-->

    <script type="text/javascript" src="/modular/system/fe-lib/jquery/1.11.2/jquery.min.js"></script>
    <script type="text/javascript" src="/modular/system/fe-lib/bootstrap/3.3.2/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/modular/system/fe-lib/jqueryui/1.10.4/js/jquery-ui.min.js"></script>
    <script type="text/javascript" src="/modular/system/fe-lib/jquery-slimScroll/1.3.3/jquery.slimscroll.min.js"></script>

    <link rel="stylesheet" href="/modular/system/userCenter/css/page-common.css">
