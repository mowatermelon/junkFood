    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <s:form name="addMenuPermForm" class="form-horizontal" action="user/perm_saveMenuPerm.action" method="post">

						<div class="form-group">
							<label for="menuName" class="col-sm-3 control-label">菜单名称</label>
							<div class="col-sm-4">
								<s:textfield name="menu.menuName" class="form-control" id="menuName" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<s:textfield name="menu.menuUrl" class="form-control" id="menuUrl" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<s:textfield name="menu.menuRemark" class="form-control" id="menuRemark" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<s:textfield name="menu.menuCode" class="form-control" id="menuCode" />
							</div>
						</div>
						...
						<div class="modal-footer">
							<button id="btnSaveMenuPower" type="button"
