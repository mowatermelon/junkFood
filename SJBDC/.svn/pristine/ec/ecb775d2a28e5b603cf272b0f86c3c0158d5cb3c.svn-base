...
/*<script type="text/javascript">*/
	...
	var basePath=$("#basePath").val();
		$("#btnPerm").click(function(){
			...
			$.post(basePath+"user/perm_list.action?respType=JSON",{"permissions.permname":permname},function(result){
				//alert(result);
		   ...
		   $("#btnUser").click(function(){
			   ...
			   //alert("roleID:"+roleID);
				...
				$.post(basePath+"user/user_queryUserAssociationRole.action?respType=JSON",{"roleID":roleID1,"choice":"0","user.userLoginName":userLoginName},function(result){
				...
				$.post(basePath+"user/user_queryUserAssociationRole.action?respType=JSON",{"roleID":roleID1,"choice":"1","user.userLoginName":userLoginName},function(result){
						var userList = result.userList;
						for(var index = 0;index<userList.length;index++)
						{  
							var userName = userList[index].userLoginName;
			 ...
			 //获取角色ID
				...
				//alert("获取的roleID:"+roleID);
				 ...
				 function getOrgData(orgID,callback,failFn){
					 ...
					 $.post(basePath+"user/org_queryOrgList.action",{"organization.orgID":orgID},function(result){
