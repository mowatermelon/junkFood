...
(function ($, window, document, undefined) {
    ...
    var old = $.fn.ligerGeowebPagin;

    // PROTOTYPE AND CONSTRUCTOR

    var ligerGeowebPagin = function (element, options) {
        this.$element = $(element);
        var opt = $.extend({}, $.fn.ligerGeowebPagin.defaults, options);
        this.init(opt);
    };

    ligerGeowebPagin.prototype = {

        constructor: ligerGeowebPagin,
    ...
    $.fn.ligerGeowebPagin = function (option) {
        ...
        var $set = this.each(function () {
            ...
            if (!data) $this.data('twbs-pagination', (data = new ligerGeowebPagin(this, options) ));
    ...
    $.fn.ligerGeowebPagin.defaults = {
        totalPages: 0,//总页数
        startPage: 1,//起始数
        visiblePages: 5,//显示按钮数
        ...
        next: 'Next',//下一页
        last: 'Last',//尾页
        paginationClass: 'pagination',//按钮样式
        onPageClick: null,//点击事件
        version: '1.0'//不同的风格1.0,1.1
    };

    $.fn.ligerGeowebPagin.Constructor = ligerGeowebPagin;

    $.fn.ligerGeowebPagin.noConflict = function () {
        $.fn.ligerGeowebPagin = old;
        return this;
    };
