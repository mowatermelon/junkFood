   ...
   <!-------------------------------------------------------TOP BEGIN----------------------------------------------------------------------->
       <div id="TOP" runat="server">
           ...
           <div id="Top_Right"  runat="server">
                ...
                <div>
		 		    <span id="span_Index" class="btnHd btnOver" onclick="showIndex()" runat="server">巧手</span>
		 		    <span id="span_Tran" class="btnHd" onclick="showTran()" runat="server">巧译</span>
		 		    <span id="span_Kind" class="btnHd btnCenter" onclick="showKind()" runat="server">巧种</span>
                    <span id="span_Prod" class="btnHd" onclick="showProd()" runat="server">巧品</span>
                    <span id="span_Cont" class="btnHd" onclick="showCont()" runat="server">巧言</span>
		 	    </div>
                    ...
                    <div id="second_mid" runat="server">
                        <ul>
                            <li class='btn'  runat="server">
                                <asp:Button ID="PrePage01"  class='all_border btn' runat="server" Text="< back" onclick="PrePage01_Click" />
                            </li>

                            <li class='btn'  runat="server">
                                <asp:Button ID="NextPage01"  class='all_border btn' runat="server" Text=" up >" onclick="NextPage01_Click" />
                            </li>

                            <li class='bom_p bom_p_f_i'  runat="server">
                                <asp:HyperLink ID="CurPageL01" runat="server" NavigateUrl="" class="bom_p bom_p_f_i"></asp:HyperLink>
                            </li>
                        </ul>
            ...
            <!-------------------------------------------------------MID PROD BEGIN-------------------------------------> 
		 		<div id="Prod" class="info" runat="server">
                        <ul id="Ul1" class="News" runat="server">
                            <li class="hNews HNews">最近发表留言的用户呢称</li>
                            <li class="hNews HNews">具体留言内容</li>                      
                        </ul>
                        ...
                        <ul>
                            <li id="Li1" class='btn'  runat="server">
                                <asp:Button ID="PrePage02"  class='all_border btn' runat="server" Text="< back" onclick="PrePage02_Click" />
                            </li>

                            <li id="Li2" class='btn'  runat="server">
                                <asp:Button ID="NextPage02"  class='all_border btn' runat="server" Text=" up >" onclick="NextPage02_Click" />
                            </li>

                            <li id="Li3" class='bom_p bom_p_f_i'  runat="server">
                                <asp:HyperLink ID="CurPageL02" runat="server" NavigateUrl="JavaScript:void(0);" class="bom_p bom_p_f_i"></asp:HyperLink>
                            </li>
                        </ul>
		 		</div>
            <!-------------------------------------------------------MID PROD OVER-------------------------------------> 
