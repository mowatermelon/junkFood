...
<body>
        ...
        <form id="form1" runat="server">
            <div id="left_top" class="ltop" runat="server">
                   ...
                   <div id="BuHome" class="atop" runat="server">
                        <asp:Button ID="Button1" runat="server" Text=" + " class="Butt"/>
                        <asp:Button ID="Button2" runat="server" Text=" / " class="Butt"/>
                        <asp:Button ID="Button3" runat="server" Text=" * " class="Butt"/>
                        <asp:Button ID="Button4" runat="server" Text=" - " class="Butt"/>
                   </div>

                   <asp:Button ID="Button5" runat="server" Text="确定" class="Butt"/>
